...
Here is a link to a [live site](http://ec2-18-221-114-146.us-east-2.compute.amazonaws.com:8080/Reimbursement/), where you can view it in action. By default, there is a manager user with the credentials `johnsamson` and `samsonite`, and an user with the credentials `emilylee` and `leelee`.
